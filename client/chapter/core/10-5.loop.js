...
// 유사배열 (arrayLike)인지 아닌지 콘솔창에서 열어서 확인
const arrayLike = {
  0: 'body',
  1: 'head',
  2: 'div',
  length: 3,
  // Symbol(Symbol.iterator) 없어서 안됨
};
...
// 콘솔창 열었을 때
// Symbol(Symbol.iterator) 있어야 for...of문 사용 가능
// for...of문은 배열 순환에 사용하세요.
...
// for문 : 모든 데이터 순환용 => 작성 코드가 많다 => 무한루프 여지가 있다.
// for...in : 객체 순환용 => 정해진 아이템의 갯수만큼 순환 => 배열 순환 X
// for...of : iterable 요소 순환용 => 정해진 아이템의 갯수만금 순환 => 배열 순환 O
...
// for...in문 예시
// 그냥 이렇게 돌아간다는 거 보여주는 거 일반적으로 안 씀
// 일반적으로는 재귀 함수 사용
