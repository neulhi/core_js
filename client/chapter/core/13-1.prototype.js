...
// 함수의 능력 (function instance method)
// call -> 함수를 대신 실행 시켜줌(함수 안의 this를 바꿔야하는 상황에 사용) -> 빌려쓰기 -> 인수 : 값
// apply -> 함수를 대신 실행 시켜줌 -> 빌려쓰기 -> 인수 : 배열(매개변수)인자를 배열 형태로 전달
// bind -> 함수를 대신 실행 하지 않음 가지고만 있다, 호출 시 새로운 함수로 반환
// this를 강제하기 위해
